...
- Default:
  ...
  - `Access-Control-Allow-Origin`: `*`
    - This is a [CORS-compliant header][cors] that allows requests to be made to the API from any
      ...
      [disabled by default](https://github.com/SmartyTeam/meteor-restivus-devel2000), or also by
...
(https://github.com/SmartyTeam/meteor-restivus-devel2000/issues/24) (client _or_ server), or do other [annoying]
(https://github.com/SmartyTeam/meteor-restivus-devel2000/issues/35) [things]
(https://github.com/SmartyTeam/meteor-restivus-devel2000/issues/43). `simple:json-routes`, and for handling the conversion
...
(https://github.com/SmartyTeam/meteor-restivus-devel2000/blob/devel/CHANGELOG.md#v080---2015-07-06).
...
(https://github.com/SmartyTeam/meteor-restivus-devel2000/blob/master/CHANGELOG.md).

## Contributing

Contributions to Restivus are welcome and appreciated! If you're interested in contributing, please
check out [the guidelines](https://github.com/SmartyTeam/meteor-restivus-devel2000/blob/master/CONTRIBUTING.md)
...
MIT License. See [LICENSE](https://github.com/SmartyTeam/meteor-restivus-devel2000/LICENSE) for
details.
...
[restivus-change-log]:  https://github.com/SmartyTeam/meteor-restivus-devel2000/blob/master/CHANGELOG.md       "Restivus Change Log"
[restivus-issues]:      https://github.com/SmartyTeam/meteor-restivus-devel2000/issues                         "Restivus Issues"
